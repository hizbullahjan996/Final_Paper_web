...
<head>
    ...
    <title>Edit Book - Library Book Management System</title>
...
<body>
    ...
    <main class="main-content">
        <div class="topbar d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 shadow-sm">
            <div>
                <h4 class="mb-0 text-primary fw-bold">Edit Book</h4>
                <span class="text-muted">Update the selected library record.</span>
            </div>
        ...
        <div class="page-area">
            <div class="card form-card shadow mx-auto">
                <div class="card-header p-4">
                    ...
                    <p class="mb-0 text-muted">Edit the details and save changes.</p>
                </div>
                <div class="card-body p-4">
                    <form action="update.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="author" name="author" class="form-control" value="<?php echo htmlspecialchars($row['author']); ?>" required>
                        </div>

                        <div class="mb-4">
                            <label for="price" class="form-label fw-semibold">Price</label>
                            <input type="number" id="price" name="price" step="0.01" class="form-control" value="<?php echo htmlspecialchars($row['price']); ?>" required>
                        </div>

                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-end">
                            <a href="view_books.php" class="btn btn-outline-secondary">
